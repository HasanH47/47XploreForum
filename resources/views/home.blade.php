                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                @if (auth()->user()->image)
                                                    ...
                                                    src="{{ asset('/storage/profile/' . auth()->user()->image) }}" alt="user image">
                                                @else
                                                    <img class="img-circle img-bordered-sm" height="50" width="50"
                                                ...
                                                <span class="description">Started a discussion -
                                                    {{ $latest_user_post->created_at->diffForHumans() }}</span>
                                            </div>
                                            <!-- /.user-block -->
                                            @if ($latest_user_post)
                                                <p>
                                            ...
                                            <p>
                                                ...
                                                <span class="float-right">
                                                    ...
                                                    @else
                                                        <a href="{{ route('topic.destroy', $latest_user_post->id) }}"
                                        ...
                                        <div class="post clearfix">
                                            <div class="user-block">
                                                @if ($latest->user->image)
                                                    <img class="img-circle img-bordered-sm" height="50" width="50"
                                                    src="{{ asset('/images/profile/' . $latest->user->image) }}" alt="User Image">
                                                @else
                                                    <img class="img-circle img-bordered-sm" height="50" width="50"
                                                    src="{{ asset('/images/profile.png') }}" alt="User Image">
                                                @endif
                                                ...
                                                <span class="description">Started a discussion -
                                                    {{ $latest->created_at->diffForHumans() }}</span>
                                            </div>
                                            <!-- /.user-block -->
                                            @if ($latest)
                                                <p>
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <form action="{{ route('user.update', auth()->id()) }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{ auth()->user()->skills }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{ auth()->user()->profession }}"
                                                    class="form-control" name="profession" placeholder="Your profession">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{ auth()->user()->country }}"
                                                    class="form-control" name="country" placeholder="Your country">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="bio"
                                                    placeholder="A short introduction about yourself eg.(a Fullstack software engineer)">{{ auth()->user()->bio }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
