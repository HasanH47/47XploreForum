...
@section('content')
  <div class="container">
      <nav class="breadcrumb" style="background-color: #e9ecef; padding: 8px 15px;">
        ...
        <a href="{{route('forum.overview', $topic->forum->id)}}" class="breadcrumb-item">
          {{$topic->forum->title}}</a>
                ...
                <tbody>
                  <tr class="table-info">
                    ...
                    <td class="post-col d-lg-flex justify-content-lg-between">
                      ...
                      <div>
                        <a href="{{route('reply.destroy', $reply->id)}}"><i class="fa fa-trash text-danger"></i></a>
                      </div>
                        @else
                        <div>
                        <a href="{{route('reply.like', $reply->id)}}" class="mr-3"><i class="fa fa-thumbs-up text-primary">{{ $reply->likes }}</i></a>
