                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                              @if ($user->image)
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('/images/profile/' . $user->image) }}"                        alt="User profile picture">                                
                              @else
                                  ...
                                  @if ($latest_user_post)
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            @if ($user->image)
                                            <img class="img-circle img-bordered-sm" height="50" width="50" src="{{ asset('/images/profile/' . $user->image) }}"
                                                alt="user image">
                                              @else
                                              <img class="img-circle img-bordered-sm" height="50" width="50" src="{{ asset('/images/profile.png') }}"
                                                alt="user image">
                                            @endif
                                            <span class="username">
                                                <a href="#">{{{$user->name}}}</a>
                                        ...
                                        <p>
                                            <a href="#" class="link-black text-sm mr-2"><i
                                                    class="fas fa-eye mr-1"></i> {{$latest_user_post->views}} views</a>
                                            <a href="#" class="link-black text-sm"><i
                                                    class="fa fa-arrow-down mr-1"></i> {{$latest_user_post->replies->count()}} replies</a>
                                            <span class="float-right">
                                                @if(auth()->user() && auth()->user()->is_admin)
                                                <a href="{{route('topic.destroy', $latest_user_post->id)}}" class="link-black text-sm">
                                  ...
                                  <div class="tab-pane" id="settings">
                                    ...
                                    <form action="{{route('user.update', $user->id)}}" method="POST" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="{{$user->name}}" id="inputName"
                                                    placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{$user->skills}}" class="form-control" name="skills"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{$user->profession}}" class="form-control" name="profession"
