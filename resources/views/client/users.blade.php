                        ...
                        <div class="card p-2 mt-3">
                            ...
                            <div class="second d-flex flex-row mt-2">
                              @if ($user->image)
                                ...
                                @else
                                <div class="image mr-3"> <img src="{{ asset('/images/profile.png' . $user->image) }}" class="rounded-circle" width="60" /> </div>
                              @endif
                                <div class="">
                                    ...
                                    @endif <a href="{{route('client.user_profile', $user->id)}}" class="btn btn-outline-dark btn-sm">See Profile</a></div>
                                </div>
                            </div>
                            <hr class="line-color">
                            @if ($user->profession)
