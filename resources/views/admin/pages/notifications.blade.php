                    ...
                    <tbody>
                        @if (count($notifications) > 0)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('notifications.read', $notification->id)}}" class="btn btn-success">Mark as Read</i></a></td>
                                <td><a href="{{route('notifications.delete', $notification->id)}}" class="text-danger"><i class="fa fa-trash text-danger"></i></a></td>
